  ...
  return (
    <section className="relative overflow-hidden bg-bg-muted py-16 md:py-24">
      ...
      <div className="container-px relative mx-auto max-w-container">
        ...
        <Reveal as="div" stagger={0.05} className="mt-10 grid items-stretch gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {documents.map((doc, i) => {
            const Icon = icons[doc.icon]
            return (
              <div key={doc.title} className="h-full" style={{ perspective: 700 }}>
                <div
                  ...
                  className="flex h-full flex-col rounded-2xl border border-line bg-surface p-6 shadow-card will-change-transform"
                >
