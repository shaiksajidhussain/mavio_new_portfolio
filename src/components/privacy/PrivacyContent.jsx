import { privacyPolicyPage } from '../../data/siteContent'
import Reveal from '../ui/Reveal'
import SectionHeading from '../ui/SectionHeading'
import Button from '../ui/Button'

const { updatedAt, intro, sections, contactNote } = privacyPolicyPage

export default function PrivacyContent() {
  return (
    <section className="container-px mx-auto max-w-container py-16 md:py-24">
      <Reveal stagger={0} className="max-w-3xl">
        <p className="text-xs font-semibold uppercase tracking-[0.18em] text-gold-deep">{updatedAt}</p>
      ...
      <Reveal
        stagger={0}
        className="mt-16 max-w-3xl rounded-3xl border border-line bg-bg-muted p-8 md:p-10"
      >
